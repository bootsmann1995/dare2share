    ...
    <form @submit.prevent="createListing" class="space-y-6">
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          <label class="flex items-center">
            <input type="checkbox" v-model="form.delivery_available" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
  ...
  try {
    ...
    const { data, error: insertError } = await supabase
      ...
      .insert({
        ...
        delivery_available: form.value.delivery_available,
